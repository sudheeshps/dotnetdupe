...
bool b2 = Convert::ToBoolean(_T("true")); // true
```
...
unsigned char b2 = Convert::ToByte(_T("FF"), 16); // 255 from Hex
```
...
TCHAR c2 = Convert::ToChar(_T("A")); // 'A'
```
...
**Usage:**
```cpp
double d = Convert::ToDouble(_T("3.14159"));
```
...
**Usage:**
```cpp
float f = Convert::ToSingle(_T("1.23"));
```
...
**Usage:**
```cpp
short s = Convert::ToInt16(_T("123"));
```
...
**Usage:**
```cpp
int i = Convert::ToInt32(_T("12345"));
int i2 = Convert::ToInt32(_T("FF"), 16); // 255
```
...
**Usage:**
```cpp
long long l = Convert::ToInt64(_T("123456789012345"));
```
...
**Usage:**
```cpp
unsigned short us = Convert::ToUInt16(_T("65535"));
```
...
**Usage:**
```cpp
unsigned int ui = Convert::ToUInt32(_T("4294967295"));
```
...
**Usage:**
```cpp
unsigned long long ull = Convert::ToUInt64(_T("18446744073709551615"));
```
