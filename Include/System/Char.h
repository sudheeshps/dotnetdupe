/// \file Char.h
/// \brief Represents a Unicode character code point mirroring .NET System.Char.
...
namespace DotNetDupe {
    namespace System {
        ...
        /// \brief Represents a Unicode character (as a UTF-32 char32_t code point).
        ///
        /// Provides static methods for classifying Unicode characters, converting between
        /// upper/lower cases, validating ASCII and Latin-1 ranges, and querying numeric values.
        /// Immutable value type; thread-safe for all operations.
        ///
        /// \note Conforms to ECMA-335 Partition IV Section 5.13 (System.Char) and Unicode 15.0.
        ...
        public:
            /// \brief Initializes a new instance of the Char class with null character.
            DOTNETDUPE_API Char();

            /// \brief Initializes a new instance of the Char class with the specified Unicode code point.
            /// \param c 32-bit Unicode code point.
            ...
            /**
             * @brief Converts the specified numeric Unicode character to a double-precision floating point number.
             * @param c Unicode code point to evaluate.
             * @return Numeric value of character if numeric; otherwise -1.0.
             */
            DOTNETDUPE_API static double GetNumericValue(char32_t c);

            /**
             * @brief Indicates whether the specified character is categorized as an ASCII character (0x00 - 0x7F).
             */
