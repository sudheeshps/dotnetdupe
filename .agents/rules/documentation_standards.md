...
- **Dual Documentation**: Markdown documentation must be kept in `docs/<Class>.md` and linked in `README.md`, while in-code Doxygen comments generate the interactive HTML documentation in `docs/html/`.
